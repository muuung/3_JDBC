...
-- 사용자 계정 생성
CREATE USER member_khj IDENTIFIED BY member1234;

-- 생성한 사용자 계정에 권한 부여
GRANT CONNECT, RESOURCE, CREATE VIEW TO member_khj;

-- 테이블 스페이스
ALTER USER member_khj DEFAULT
...
-- 회원 정보 수정(이름, 성별)
UPDATE MEMBER SET MEMBER_NM = '바꾼이름', MEMBER_GENDER = 'F'
WHERE MEMBER_NO = 1;
...
-- 비밀번호 변경
UPDATE MEMBER SET MEMBER_PW = '새비밀번호'
WHERE MEMBER_NO = 1 AND MEMBER_PW = 'pass01';

-- 회원 탈퇴(SECESSION_FL 컬럼의 값을 'Y'로 변경)
UPDATE MEMBER SET SECESSION_FL = 'Y'
WHERE MEMBER_NO = 2 AND MEMBER_PW = 'pass02';
...
(SEQ_BOARD_NO.NEXTVAL, '샘플 제목1', '샘플 내용 1 입니다.',
 TO_DATE('2022-09-20 10:30:12', 'YYYY-MM-DD HH24:MI:SS'),
 DEFAULT, DEFAULT, 3);

INSERT INTO BOARD VALUES
(SEQ_BOARD_NO.NEXTVAL, '샘플 제목2', '샘플 내용 2 입니다.',
 TO_DATE('2022-09-21 20:17:12', 'YYYY-MM-DD HH24:MI:SS'),
 DEFAULT, DEFAULT, 3);

INSERT INTO BOARD VALUES
(SEQ_BOARD_NO.NEXTVAL, '샘플 제목3', '샘플 내용 3 입니다.',
 DEFAULT, DEFAULT, DEFAULT, 3);

INSERT INTO BOARD VALUES
(SEQ_BOARD_NO.NEXTVAL, '샘플 제목4', '샘플 내용 4 입니다.',
 DEFAULT, DEFAULT, DEFAULT, 3);

INSERT INTO BOARD VALUES
(SEQ_BOARD_NO.NEXTVAL, '샘플 제목5', '샘플 내용 5 입니다.',
 DEFAULT, DEFAULT, DEFAULT, 3);
...
COMMENT ON COLUMN "COMMENT".COMMENT_CONTENT IS '댓글 번호';
